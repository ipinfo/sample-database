...
_[data updated as of June, 2025]_
...
| percent_days_seen | 2                | INTEGER   | Integer indicating the percentage of days the IP was active in the last 30-day period, reflecting its activity and frequency of IP within a residential proxy pool. |
...
- [Parquet Database] [IP to Residental Proxy Database Sample](/IP%20Residential%20Proxy/ip_residential_proxy_sample.parquet)
